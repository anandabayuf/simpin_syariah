...
class InformasiPengajuanPembiayaanScreen extends StatelessWidget{
  final Pembiayaan pembiayaan;

  InformasiPengajuanPembiayaanScreen(this.pembiayaan);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: CustomText('Informasi Pembiayaan', 24.0, false),
        centerTitle: true,
        elevation: 0,
